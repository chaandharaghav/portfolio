...
const Project = ({ project }: { project: project }) => {
    ...
    return (
        <div className="w-full p-6 mb-6 bg-white border-t-4 rounded-sm dark:bg-dark_project_bg dark:border-t-8 dark:border-t-gray-500 border-t-gray-300 dark:text-black">
            ...
            <p className="text-sm underline break-words hover:cursor-pointer">
                <Link href={link}>{link}</Link>
            </p>
            <p className="mt-5 text-sm">{description}</p>
            <div className="flex flex-wrap mt-2 lg:mt-6">
...
const Pill = ({
    ...
    return (
        <div className="px-2.5 py-0.5 rounded-2xl border dark:border-gray-600 mr-3 mt-2">
            {isStatus && statusComp}
