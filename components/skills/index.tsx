...
const Skills = ({ skills }: { skills: string[] }) => {
    return (
        <div>
            <h4 className="mb-2 text-lg font-bold lg:mb-6">Skills</h4>
...
const Skill = ({ name }: { name: string }) => {
    return (
        <li className="m-4 lg:m-0 rounded-full flex w-20 lg:w-32 [&:nth-child(1)]:text-blue-500 [&:nth-child(2)]:text-pink-500 [&:nth-child(3)]:text-orange-500 ">
